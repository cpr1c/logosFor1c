...
Процедура Инициализировать(ИспользоватьОсновную = Истина, Настройка = "") Экспорт
	...
	Если ИспользоватьОсновную И Метаданные.Константы.Найти("лНастройкиЛогирования") <> Неопределено Тогда
		СохраненныеНастройкиЛогирования(Константы.лНастройкиЛогирования.Получить());
...
Функция СохраненныеНастройкиЛогирования(Настройка)
	...
	Настройки.Вставить("ПриоритетУровняЛогирования", лЛог.ПриоритетУровняЛогирования(Выборка.УровеньЛогирования));
	...
	Пока ВыборкаСпособы.Следующий() Цикл
		НастройкиСпособа = Новый Структура("ШаблонСообщения,ФорматДаты,Представление", ВыборкаСпособы.ШаблонСообщения, ВыборкаСпособы.ФорматДаты, ВыборкаСпособы.СпособЛогированияПредставление);
	...
	Если Настройки.СпособыЛогирования[Перечисления.лСпособыЛогирования.Файл] = Неопределено Тогда
...
Функция НастройкиЛогированияПоУмолчанию()
	...
	Настройки.Вставить("ПриоритетУровняЛогирования", лЛог.ПриоритетУровняЛогирования(Настройки.УровеньЛогирования));
...
Процедура ЗавершитьЛогирование() Экспорт
	...
	ПараметрыСеанса.лПараметрыЛогирования = Новый ФиксированнаяСтруктура(Новый Структура);
...
Процедура ДобавитьЗаписьВЖурналРегистрации(Сообщение, ДопПараметры) Экспорт
	...
	Текст = лЛог.СтрокаСообщенияЛога(Сообщение, ДопПараметры);
...
Процедура УстановитьУровеньЛогирования(Знач УровеньЛогирования) Экспорт
	...
	Настройки.Вставить("ПриоритетУровняЛогирования", лЛог.ПриоритетУровняЛогирования(УровеньЛогирования));
