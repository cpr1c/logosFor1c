...
Функция СпособыЛогирования() Экспорт
	...
	#Иначе
		ТекущиеПараметрыСеанса = лЛогСлужебныйСервер.ТекущиеПараметрыСеансаНаСервере();
	...
	лЛогПереопределяемый.ПриОпределенииСпособовЛогирования(Способы);
...
Функция ПараметрыСпособаЛогирования(СпособИлиИмяСпособа) Экспорт
	...
	Иначе
		...
		лЛогПереопределяемый.ПриОпределенииПараметровСпособаЛогирования(ТекущийСпособ.Имя, ПараметрыСпособа);
...
Процедура ЗавершитьЛогирование(ЛогИлиИмяЛога = Неопределено) Экспорт
	...
	лЛогСлужебныйСервер.УдалитьЛогИзХранилищаЛогов(ТекущийЛог);	
КонецПроцедуры
...
Процедура ОпределитьСпособЛогированияИзОбщегоМодуля(Способы, ИмяОбщегоМодуля) Экспорт
	...
	НовыйСпособ = лЛогСлужебный.НовыйСпособЛогирования();
...
Процедура ВыполнитьЗаписьЛогаПоСпособу(Лог, СпособЛогированияДляЛога, УровеньЛогирования, Сообщение) Экспорт
	...
	Иначе
		лЛогПереопределяемый.ПриВыводеСообщенияВЛогПоСпособу(СообщениеДляЗаписи, Лог, УровеньЛогирования, СпособЛогирования.Имя, Параметры);
	КонецЕсли;
...
Функция ПрефиксОбщихМодулейОпределяющихСпособыЛогирования() Экспорт
	...
	лЛогПереопределяемый.ПриОпределенииПрефиксаОбщихМодулейОпределяющихСпособыЛогирования(Префикс);
...
Функция НовыйПустойЛог(ИмяЛога) 
	...
	Настройка.Вставить("ИмяПользователя", лЛогСлужебныйСервер.ИмяТекущегоПользователяБазы());
	#Иначе
