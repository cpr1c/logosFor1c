...
Процедура ЗавершитьЛогирование(ЛогИлиИмяЛога = Неопределено) Экспорт
	лЛогСлужебный.ЗавершитьЛогирование(ЛогИлиИмяЛога);
КонецПроцедуры
...
Процедура УстановитьШаблонСообщения(Шаблон, ЛогИлиИмяЛога = Неопределено) Экспорт
	лЛогСлужебный.УстановитьШаблонСообщения(Шаблон, ЛогИлиИмяЛога);
КонецПроцедуры
...
Процедура ДобавитьСпособЛогирования(Способ, Параметры, ЛогИлиИмяЛога = Неопределено, Контекст = "") Экспорт
	лЛогСлужебный.ДобавитьСпособЛогирования(Способ, Параметры, ЛогИлиИмяЛога, Контекст);
КонецПроцедуры
...
Процедура ДобавитьСпособЛогированияИзОбщегоМодуля(Способы, ИмяОбщегоМодуля) Экспорт
